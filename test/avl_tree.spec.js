...
fdescribe('AvlTree', function() {
  ...
  it('should create balanced tree: case #2', function() {
  ...
  it('should do left right rotation and keeping left right node safe', function() {
    const tree = new AvlTree();
  ...
  it('should remove values from the tree with right-right rotation', function() {
    const tree = new AvlTree();
  ...
  it('should remove values from the tree with left-left rotation', function() {
    const tree = new AvlTree();
  ...
  it('should keep balance after removal', function() {
    const tree = new AvlTree();
